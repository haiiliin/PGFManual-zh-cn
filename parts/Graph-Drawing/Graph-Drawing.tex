...
\input{parts/Graph-Drawing/sections/pgfmanual-en-gd-overview}
\input{parts/Graph-Drawing/sections/pgfmanual-en-gd-usage-tikz}
\input{parts/Graph-Drawing/sections/pgfmanual-en-gd-usage-pgf}
\input{parts/Graph-Drawing/sections/pgfmanual-en-gd-trees}
\input{parts/Graph-Drawing/sections/pgfmanual-en-gd-layered}
\input{parts/Graph-Drawing/sections/pgfmanual-en-gd-force}
\input{parts/Graph-Drawing/sections/pgfmanual-en-gd-circular}
\input{parts/Graph-Drawing/sections/pgfmanual-en-gd-phylogenetics}
\input{parts/Graph-Drawing/sections/pgfmanual-en-gd-edge-routing}
%
% XXX : disabled because of
% 1. compile-time dependencies which are hard to resolve
% 2. it is "hardly usable anyway" (TT)
%\input{parts/Graph-Drawing/sections/pgfmanual-en-gd-ogdf}
\input{parts/Graph-Drawing/sections/pgfmanual-en-gd-algorithm-layer}
\input{parts/Graph-Drawing/sections/pgfmanual-en-gd-algorithms-in-c}
\input{parts/Graph-Drawing/sections/pgfmanual-en-gd-display-layer}
\input{parts/Graph-Drawing/sections/pgfmanual-en-gd-binding-layer}